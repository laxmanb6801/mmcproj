...
<p align="center"><strong><font size="5" color="#CC0000">ADMIN REGISTRATION</font></strong></p>
<form action="adminreginst.jsp" name="f1" method="post" onsubmit="return val();">
  ...
  <td class="field"><input type="text" name="sal"></td>
  </tr>
  <tr>
