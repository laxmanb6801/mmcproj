...
String sss = "update empdetl set fullname='"+fn+"',age='"+age+"',gender='"+gender+"',addr='"+addr+"',city='"+city+"',dis='"+dis+"',state='"+state+"',pin='"+pin+"',salary='"+sal+"',mobile='"+mobile+"',mail='"+mail+"',emptyp='"+emtyp+"',username='"+unam+"',pass='"+pass+"'where empid='"+rgn+"'"; 
...
%>
<jsp:forward page="adminviewemply.jsp" />
