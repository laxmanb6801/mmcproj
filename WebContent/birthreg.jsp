...
if(document.f1.pob[0].checked==false&&document.f1.pob[1].checked==false&&document.f1.pob[2].checked==false)
{
alert("Select The Place Of Birth");
return false;
}
...
<p align="center"><strong><font size="5" color="#CC0000">BIRTH REGISTRATION</font></strong></p>
<form action="insertbirth.jsp" name="f1" method="post" onsubmit="return val();">
  <table align="center" width="600" height="600" border="0">
        <tr> 
          <td class="new1"><strong><font size="4">Child Name:</font></strong></td>
  <td class="field"><input type="text" name="cnam"></td>
  </tr>
   <tr>
  ...
  <td><input type="radio" name="pob" value="Home">Home&nbsp;&nbsp;&nbsp;<input type="radio" name="pob" value="Hospital">Hospital
  &nbsp;&nbsp;&nbsp;<input type="radio" name="pob" value="NotKnown">NotKnown</td>
  </tr>
  <tr>
  ...
  <tr>
  <td class="new1"><strong><font size="4">Hospital Certificate No:</font></strong> </td>
