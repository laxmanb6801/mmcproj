  ...
  ResultSet rs1 = null;
	...
	try
     ...
     //   st = con.createStatement();
		st = con.prepareStatement("select * from admin where fullname ='"+b+"'");
		rs1 = st.executeQuery();
		while(rs1.next())
         {
		 %>
...
<form action="instadminupdate.jsp" name="f1" method="post" onsubmit="return val();">
  ...
  <td class="field"><input type="text" name="dob" value="<%=rs1.getString(5)%>" ></td>
  </tr>
  <tr>
  ...
  <td><input type="text" name="cty" value="<%=rs1.getString(7)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Distric : </font></strong></td>
  <td class="field"><input type="text" name="disc" value="<%=rs1.getString(8)%>"></td>
  </tr>
   <tr>
  <td class="new1"><strong><font size="4">State:</font></strong> </td>
  <td class="field"><input type="text" name="stat" value="<%=rs1.getString(9)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Pin:</font></strong> </td>
  <td class="field"><input type="text" name="pin" value="<%=rs1.getString(10)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Salary:</font></strong> </td>
  <td class="field"><input type="text" name="sal" value="<%=rs1.getString(11)%>"></td>
  </tr>
  <tr>
...
<div id="footer">
	<p class="legal"><strong><font size="4"><a href="index.html">copy righ@2016</a></font></strong></p>
	</div>
