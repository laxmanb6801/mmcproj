...
var d = document.f1.occ.value;
if(d=="")
{
alert("Enter your occupation");
document.f1.occ.focus();
return false;
}
...
if(document.f1.id.selectedIndex==0)
{
alert("Select Id card type");
return false;
}
var j = document.f1.num.value;
if(j=="")
{
...
if(isNaN(j))
{
alert("Enter card number in numbers");
document.f1.num.focus();
return false;
}
if(j.length!=10)
{
alert("Enter 10 digits card no");
document.f1.num.focus();
return false;
}
...
<p align="center"><strong><font size="5" color="#CC0000">REGISTRATION OF NEW USER</font></strong></p>
<form action="insertregs.jsp" name="f1" method="post" onsubmit="return val();">
  ...
  <tr>
  <td class="new1"><strong><font size="4">Occupation :</font></strong> </td>
  <td class="field"><input type="text" name="occ" ></td>
  </tr>
  <tr>
  ...
  <tr>
  <td class="new1"><strong><font size="4">Identity card type : </font></strong></td>
  <td><select name="id">
  ...
  <tr>
  <td class="new1"><strong><font size="4">Card number :</font></strong> </td>
  <td class="field"><input type="text" name="num"></td>
  </tr>
  <tr>
