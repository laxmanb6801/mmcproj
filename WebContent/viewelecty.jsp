...
<p align="center"><font color="#FF0000" size="5"><strong>ELECTRICITY  PETITIONS</strong></font></p>
  ...
  String  a = null,b = null,c = null,d = null,e = null,f=null,g=null,h=null,i=null;
	...
	try
     ...
     //   st = con.createStatement();
		st = con.prepareStatement("select * from electcompl");
		rs = st.executeQuery();
		while(rs.next())
       	{
	   
	    
		   a=rs.getString("elecomno");
