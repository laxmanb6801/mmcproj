...
<p align="center"><font color="#FF0000" size="5"><strong>TENDER APPLICATIONS</strong></font></p>
<form action="#" name="f1" method="post" onsubmit="return val();">
  ...
  <tr> 
      ...
      <th width="100"> <font color="#FF0000">Apply Date</font></th>
	  <th width="250"> <font color="#FF0000">Address</font></th>
	  <th width="250"> <font color="#FF0000">Tender Code</font></th>
	  <th width="100"> <font color="#FF0000">Tender Detail</font></th>
	  <th width="100"> <font color="#FF0000">Tender Amount</font></th>
	  <th width="100"> <font color="#FF0000">License No</font></th>
  ...
  String  a = null,b = null,c = null,d = null,e = null,f=null,g=null,h=null,i=null,j=null,k=null;
	...
	try
       ...
       // con = databasecon.getconnection(); 
		st = con.prepareStatement("select * from applytender");
		rs = st.executeQuery();
		while(rs.next())
       	{
		   ...
		   g=rs.getString("tendercode");
		   h=rs.getString("tenderdetaile");
		   i=rs.getString("tenderamount");
		   j=rs.getString("licenseno");
		   k=rs.getString("status");
