...
function val()
{
if(document.f1.tax.selectedIndex==0)
{
alert("Select Tax type");
return false;
}
if(document.f1.rs.selectedIndex==0)
{
alert("Select Amount Duration(Rs For)");
return false;
}
var a = document.f1.amount.value;
if(a=="")
{
...
<p align="center"><font size="4"><strong>ONLINE PAYMENT</strong></font></p>
<form action="insertpay.jsp" name="f1" method="post" onsubmit="return val();">
<table width="120%" border="0">
  ...
  <td><input disabled="true" type="text" value="<%=addr%>" name="adrs"></td>
   ...
   <tr>
  <td class="new1"><strong><font size="4">Tax For</font></strong></td>
  <td><select name="tax">
  <option selected value>--type--</option>
  <option>Metro Water</option>
  <option>Vaitha</option>
  <option>Shop Rent</option>
  <option>Corp Shop Rent</option>
  <option>Property Tax</option>
  </select></td>
  </tr>
   <tr>
  <td><strong><font color="#000000" size="4">Rs For</font></strong></td>
  <td><select name="rs">
  ...
  <tr> 
  <td><strong><font color="#000000" size="4">Amount</font></strong></td>
  ...
  <input type="submit" name="sub" value="Register" class="button"></td>
	...
	<p align="center"><a href="taxdtl.jsp" class="comments">BACK</a> &nbsp;&nbsp;&nbsp; <a href="#" class="permalink"></a></p>
</div>
</div>
<div id="footer">
