...
String sss = "insert into sanitatcompl(username,mailid,mobile,date,address,complaints,status) values('"+nam+"','"+mid+"','"+mob+"','"+dat+"','"+adrs+"','"+compl+"','"+status+"')";
int x = st.executeUpdate(sss);
if(x!=0)
{
%>
<jsp:forward page="successsani.jsp"/>
<%
}
else
{
