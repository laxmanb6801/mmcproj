...
ResultSet rs=null;
String a=null;
String cnm = request.getParameter("chname");
String rg = request.getParameter("rgno");

Connection con = databasecon.getconnection();
Statement st = con.createStatement();
String s = "select status from birthreg where regidno='"+rg+"' and childname='"+cnm+"'";
...
<p align="center"><font color="#FF0000" size="6"><strong>YOUR REQUEST STATUS IS: <%=a%></strong></font></p>
