...
<form action="instmwcompl.jsp" name="f1" method="post" onsubmit="return val();">
<table width="120%" border="0">
  ...
  <input type="submit" name="sub" value="Register" class="button"></td>
	...
	<p align="center"><a href="metwater1.jsp" class="comments">BACK</a> &nbsp;&nbsp;&nbsp; <a href="#" class="permalink"></a></p>
</div>
</div>
<div id="footer">
