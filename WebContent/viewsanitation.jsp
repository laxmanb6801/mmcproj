...
<p align="center"><font color="#FF0000" size="5"><strong>SANITATION PETITIONS</strong></font></p>
<form action="#" name="f1" method="post" onsubmit="return val();">
  ...
  <tr> 
	  ...
	  <th width="250"> <font color="#FF0000">Complaints</font></th>
	  <th width="100"> <font color="#FF0000">Status</font></th>
	  <th width="100"> <font color="#FF0000">Feedback</font></th>
    </tr>
  ...
  String  a = null,b = null,c = null,d = null,e = null,f=null,g=null,h=null,i=null;
	...
	try
     ...
     //   st = con.createStatement();
		st = con.prepareStatement("select * from sanitatcompl");
		rs = st.executeQuery();
		while(rs.next())
       	{
	   
	    
		   a=rs.getString("sancomno");
		   b=rs.getString("username");
		   c=rs.getString("mailid");
		   d=rs.getString("mobile");
		   e=rs.getString("date");
		   f=rs.getString("address");
		   g=rs.getString("complaints");
		   h=rs.getString("status");
		   i=rs.getString("feedback");
