...
if(a=="")
{
alert("Enter The Tender Code");
document.f1.tcod.focus();
return false;
}
var b = document.f1.tdtl.value;
if(b=="")
{
alert("Enter The Tender Details");
document.f1.tdtl.focus();
return false;
}
var c = document.f1.tamt.value;
if(c=="")
{
alert("Enter The Tender Amount");
document.f1.tamt.focus();
return false;
}
}
</script>
...
<p align="center"><font size="4"><strong>TENDER FORM</strong></font></p>
<form action="insttender.jsp" name="f1" method="post" onsubmit="return val();">
<table width="120%" border="0">
  ...
  <td><input disabled="true" type="text" value="<%=addr%>" name="adrs"></td>
   ...
   <tr>
  <td><strong><font color="#000000" size="4">Tender Code: </font></strong></td>
  <td><input type="text" name="tcod"></td>
  </tr>
  <tr>
  <td><strong><font color="#000000" size="4">Tender Details: </font></strong></td>
  <td><input type="text" name="tdtl"></td>
  </tr>
  <tr>
  <td><strong><font color="#000000" size="4">Tender Amount: </font></strong></td>
  <td><input type="password" name="tamt"></td>
  </tr>
  <tr>
  <td><strong><font color="#000000" size="4">Contractor License No: </font></strong></td>
  <td><input type="text" name="clno"></td>
  </tr>
   <tr>
   <td></td>
  <td>
...
<div id="footer">
	...
	<%
	//session.setAttribute("comple",compl);
	}
	catch(Exception x)
   {
