...
<p align="center"><font color="#FF0000" size="5"><strong>BIRTH REGISTRATION PETITIONS</strong></font></p>
<form action="#" name="f1" method="post" onsubmit="return val();">
  <table align="left" border="1" cellpadding="0" cellspacing="0">
  <tr> 
      <th ><font color="#FF0000">Reg Id</font></th>
      <th > <font color="#FF00000">Child Name</font></th>
      <th width="50"> <font color="#FF0000">Gender</font></th>
      <th width="50"> <font color="#FF0000">BirthDate</font>
      <th width="50"> <font color="#FF0000">BirthPlace </font></th>
	  <th width="50"> <font color="#FF0000">Address</font></th>
	  <th width="50"> <font color="#FF0000">Fat Name</font></th>
	  <th width="50"> <font color="#FF0000">Mot Name</font></th>
	  <th width="50"> <font color="#FF0000">RationCard NO</font></th>
	  <th width="50"> <font color="#FF0000">Hsp/Vao Cerf No</font></th>
	  <th width="50"> <font color="#FF0000">Mobile No</font></th>
	  <th width="50"> <font color="#FF0000">Mail Id</font></th>
	  <th width="50"> <font color="#FF0000">Status</font></th>
	  <th width="50"> <font color="#FF0000">Update</font></th>
    </tr>
  ...
  String  b = null,c = null,d = null,e = null,f=null,g=null,h=null,i=null,j=null,k=null,l=null,m=null;
	...
	try
     ...
     //   st = con.createStatement();
		st = con.prepareStatement("select * from birthreg");
		rs = st.executeQuery();
		while(rs.next())
       	{
		   ...
		   a=rs.getInt("regidno");
		   b=rs.getString("childname");
		   c=rs.getString("gender");
		   d=rs.getString("dateofbirth");
		   e=rs.getString("placeofbirth");
		   f=rs.getString("address");
		   g=rs.getString("fathername");
		   h=rs.getString("mothername");
		   i=rs.getString("rationcardno");
		   j=rs.getString("hospitalno");
		   k=rs.getString("mobileno");
		   l=rs.getString("mailid");
		   m=rs.getString("status");
...
%>
	   <td> <a href="updatebirth1.jsp?<%=b%>">Update</a></td>
	   </tr>
      <%
