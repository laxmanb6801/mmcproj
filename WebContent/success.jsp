...
<hr/>
<%
String id1 = (String) session.getValue("id");
String name3 = (String) session.getValue("name2");
%>
...
<p align="center"><font color="#000000" size="4">THANKS MR/MRS: <%=name3%> AND YOUR REQUEST REFERENCE NO <%=id1%></font></p>
<p align="center"><font color="#000000" size="4">IN CASE OF ANY ISSUE CONTACT YOURS HELP LINE NO</font></p>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
 &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
