...
function val()
{
var z = document.f1.rdd.value;
if(z=="")
{
alert("Enter Reg Id");
document.f1.rdd.focus();
return false;
}
...
var x = document.f1.pod.value;
if(x=="")
{
alert("Enter Place Of Death");
document.f1.pod.focus();
return false;
}
...
var w = document.f1.hcn.value;
if(w=="")
{
alert("Enter Hospital/Vao Cerf No");
document.f1.hcn.focus();
return false;
}
  ...
  ResultSet rs1 = null;
	...
	try
     ...
     //   st = con.createStatement();
		st = con.prepareStatement("select * from deathreg where personname='"+b+"'");
		rs1 = st.executeQuery();
		while(rs1.next())
         {
		 %>
...
<form action="instdeathupdate.jsp" name="f1" method="post" onsubmit="return val();">
  <table align="center" width="600" height="100" border="0">
  <tr> 
  <td class="new1"><strong><font size="4">Reg Id No</font></strong></td>
  <td class="field"><input type="text" name="rdd" value="<%=rs1.getInt(1)%>"></td>
  </tr>
  <tr> 
  <td class="new1"><strong><font size="4">Person Name:</font></strong></td>
  <td class="field"><input type="text" name="pnam" value="<%=rs1.getString(2)%>"></td>
  </tr>
   <tr>
  ...
  <td class="field"><input type="text" name="dod" value="<%=rs1.getString(5)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Place Of Death:</font></strong> </td>
  <td><input type="text" name="pod" value="<%=rs1.getString(6)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Address : </font></strong></td>
  <td class="field"><input type="text" name="adrs" value="<%=rs1.getString(7)%>"></td>
  </tr>
   <tr>
  <td class="new1"><strong><font size="4">Name Of Father Or Husband:</font></strong> </td>
  <td class="field"><input type="text" name="fatnm" value="<%=rs1.getString(8)%>e"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Name Of Mother :</font></strong> </td>
  <td class="field"><input type="text" name="motnm" value="<%=rs1.getString(9)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Ration Card No:</font></strong> </td>
  <td class="field"><input type="text" name="rcn" value="<%=rs1.getString(10)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Hospital(or)VAO Cerf No:</font></strong> </td>
  <td class="field"><input type="text" name="hcn" value="<%=rs1.getString(11)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">Mobile No :</font></strong> </td>
  <td class="field"><input type="text" name="mobile" value="<%=rs1.getString(12)%>"></td>
  </tr>
  <tr>
  <td class="new1"><strong><font size="4">E-Mail ID :</font></strong> </td>
  <td class="field"><input type="text" name="mail" value="<%=rs1.getString(13)%>"></td>
  </tr>
  <tr>
  <td></td>
	  <td><input type="submit" name="sub" value="Update" class="button"></td>
	  </tr>
  </table>
  </form>
 
	<p align="center"><a href="adminviewdeath.jsp">BACK</a> &nbsp;&nbsp;&nbsp; <a href="#" class="permalink"></a></p>
</div>
</div>
<%
