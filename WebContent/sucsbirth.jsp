...
String id5 = (String) session.getValue("idbd"); 
%>
...
<p align="center"><font color="#000000" size="4">THANK YOU Mr/Mrs :<%=name1%> YOU CAN GET YOUR CERTIFECATE ON NEXT 5th WORKING DAY YOUR REQUEST REFERENCE NO: <%=id5%></font></p>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
 &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
...
<div id="footer">
	<p class="legal"><strong><font size="4"><a href="index.html">Home page</a></font></strong></p>
	</div>
</body>
</html>
