...
function val()
{
var a = document.f1.chname.value;
if(a=="")
{
alert("Enter first name");
document.f1.chname.focus();
return false;
}
...
<form action="statusbirth1.jsp" name="f1" method="post" onsubmit="return val();">
<table width="120%" border="0">
  
  <tr>
  <td><strong><font color="#000000" size="4">Child Name:</font></strong></td>
